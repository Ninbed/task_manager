    ...
    <div class="d-flex">
        ...
        <div class="sidebar">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item"><a class="nav-link mt-2" href="{{ route('tasks.index') }}"><i class="fa fa-file"></i> My Tasks</a></li>
                <li class="nav-item"><a class="nav-link" href="{{ route('tasks.notifications') }}"><i class="fa fa-bell"></i> Notifications</a></li>
                <li class="nav-item"><a class="nav-link" href="{{ route('tasks.today') }}"><i class="fa fa-calendar-alt"></i> Today</a></li>
                <li class="nav-item"><a class="nav-link" href="{{ route('tasks.upcoming') }}"><i class="fa fa-clock"></i> Upcoming</a></li>
                <li class="nav-item"><a class="nav-link" href="{{ route('tasks.completed') }}"><i class="fa fa-check-circle"></i> Completed</a></li>
            </ul>
        </div>
        ...
        <div class="col-md-6 mb-3 d-flex">
            <div class="card shadow-sm text-center flex-fill">
                <div class="card-body">
                    ...
                    <a href="{{ route('tasks.today') }}" class="btn btn-primary  btn-lg w-100">
        ...
        <div class="col-md-6 mb-3">
            <div class="card shadow-sm text-center">
                <div class="card-body">
                    ...
                    <a href="{{ route('tasks.upcoming') }}" class="btn btn-danger btn-lg w-100">
