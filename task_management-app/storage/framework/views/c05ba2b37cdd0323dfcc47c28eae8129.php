                    ...
                    <ul class="navbar-nav ms-auto align-items-center">
                        <?php if(auth()->guard()->guest()): ?>
                            <?php if(Route::has('login')): ?>
                                <li class="nav-item">
                                    <a class="nav-link btn-custom btn-login" href="<?php echo e(route('login')); ?>">
                            ...
                            <?php if(Route::has('register')): ?>
                                <li class="nav-item ms-2">
                                    <a class="nav-link btn-custom btn-register" href="<?php echo e(route('register')); ?>">
                                        <i class="bi bi-person-plus"></i> <?php echo e(__('Register')); ?>
...
</html><?php /**PATH C:\xampp\htdocs\task_management-app\resources\views/layouts/app.blade.php ENDPATH**/ ?>